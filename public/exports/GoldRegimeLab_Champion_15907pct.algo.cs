// ═══════════════════════════════════════════════════════════════
// Hill-Climb 15907.21% ret / 18.47% DD (London+NewYork)
// Category: HIGH | Generated: 2026-03-16
// Gold Regime Lab v3 — XAUUSD 3-State Regime cBot
// ═══════════════════════════════════════════════════════════════
// Backtest Stats: Return 15907.21% | WR 65.2% | PF 3.19 | MaxDD 18.47%
// Trades: 23 (0W/0L) | AvgR 0
// ═══════════════════════════════════════════════════════════════
//
// ✓ All parameters within safe definitions — no risk warnings
// Computed Risk Rating: MED | RR=4:1 Risk=1.75% Lev=10x
...
namespace cAlgo.Robots
{
    ...
    public class Hillclimb1590721Ret1847DdLondonnewyork : Robot
    {
        // ── Core Parameters ──────────────────────────────────────────
        ...
        // ── Risk Management ──────────────────────────────────────────
        [Parameter("Risk Per Trade %", Group = "Risk", DefaultValue = 1.75, MinValue = 0.1, MaxValue = 10.0, Step = 0.05)]
        ...
        {
            _botLabel = "Hillclimb1590721Ret1847DdLondonnewyork_" + Server.Time.Ticks;
            ...
            Print("Hillclimb1590721Ret1847DdLondonnewyork started — HIGH risk category");
            Print("Config: RR=4 ATR=3 Risk=1.75% Lev=10x");
        }
        ...
        {
            Print("Hillclimb1590721Ret1847DdLondonnewyork stopped. Final balance: " + Account.Balance);
        }
    }
}
